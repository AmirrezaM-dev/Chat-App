							...
							<div className="card">
								<div className="card-body">
									<div className="media">
										...
										<div className="media-options ms-1 d-none d-sm-block">
											<button
												className="btn btn-secondary btn-icon btn-minimal btn-sm text-muted"
												type="button"
											>
										...
										<li className="list-group-item py-2">
											<div className="media align-items-center">
												<div className="media-body">
													...
													<p className="small text-muted mb-0">
														Ask for a code if
														attempted login from an
														unrecognised device or
														browser.
													</p>
												</div>
												<div className="custom-control custom-switch me-2">
