...
const MessangerApp = () => {
	...
	useEffect(() => {
		...
		switch (side) {
			...
			case undefined:
			default:
				document.querySelector("body").classList.add("chats-tab-open")
				break
			case "calls":
				document.querySelector("body").classList.add("calls-tab-open")
				break
			case "contacts":
				document.querySelector("body").classList.add("friends-tab-open")
				break
			case "profile":
				document.querySelector("body").classList.add("profile-tab-open")
		}
	}, [side])
	return (
		<>
				...
				<div className="modal-dialog modal-dialog-centered modal-dialog-scrollable modal-dialog-zoom">
					<div className="modal-content">
						<div className="modal-header">
							<h5
								className="modal-title js-title-step"
								id="createGroupLabel"
							>
								&nbsp;
							</h5>
								...
								<Col sm={12}>
									<div className="d-flex justify-content-center align-items-center flex-column h-100">
										...
										<p className="text-muted text-center">
											...
											Dolores cumque laborum fugiat vero
											pariatur provident!
										</p>
									</div>
								</Col>
						...
						<div className="modal-footer">
							<button
								type="button"
								className="btn btn-link text-muted js-btn-step me-auto"
						...
						<div className="modal-body hide-scrollbar">
							<form>
								<div className="row">
									<Col sm={12}>
										<div className="form-group">
											<label htmlFor="inviteEmailAddress">
												Email address
											</label>
											<input
												type="email"
